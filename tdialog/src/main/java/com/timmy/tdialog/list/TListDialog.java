...
public class TListDialog extends TDialog {
    ...
    protected void bindView(View view) {
        ...
        if (tController.getAdapter() != null) {//有设置列表
            ...
            if (tController.getLayoutManagerType() == 0) {
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(view.getContext(),
                        tController.getOrientation(), false);
                recyclerView.setLayoutManager(layoutManager);
            } else if (tController.getLayoutManagerType() == 1) {
                GridLayoutManager gridLayoutManager = new GridLayoutManager(view.getContext(),
                        tController.getSpanCount(), tController.getOrientation(), false);
    ...
    public static class Builder {
        ...
        public TListDialog.Builder setListLayoutRes(@LayoutRes int layoutRes, int orientation) {
            ...
            params.layoutManagerType = 0;
            return this;
        }

        //设置自定义列表布局和方向
        public TListDialog.Builder setListLayoutRes(@LayoutRes int layoutRes, int orientation, int spanCount) {
            params.listLayoutRes = layoutRes;
            params.orientation = orientation;
            params.layoutManagerType = 1;
